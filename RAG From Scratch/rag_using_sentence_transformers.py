...
# General Description:
# This file implements RAG using contextual embeddings(generated using sentence_transformers_embeddings.py) for getting similar text chunks from document
...
class RAGUsingSenteceTransformers:
    def __init__(self):
...
{context}. Answer:"""
    ...
    def retrieve_relevant_resources(self, query: str, embeddings: torch.tensor, n_resources_to_return: int=5, print_time: bool=True):
        """
        Embeds a query with model and returns top k scores and indices from embeddings.
        """
        model = self.the_embedding_model
        # Embed the query
    ...
    def read_and_generate(self):
        ...
        self.eval_ans_df.to_csv('Generated_Ans_RAG.csv', index=False, escapechar='\\')
        print("\n Completed generating answers")

    
def main():
    rag = RAGUsingSenteceTransformers()
